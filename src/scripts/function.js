  ...
  return `
    <li data-key="${link.key}" class="main__link" data-link-id="${link.id}">
      ...
      <div class="main__link_actions">
        <button data-link-id="${
          link.id
        }" type="button" class="copy_link" aria-action="copy">
        ...
        <button data-link-id="${link.id}" data-key="${
    link.key
  }" class="erase_link" type="button" id="erase-link" aria-action="erase" aria-label="button to erase links">
